...
void ANO_DT_Data_Exchange(void)
{
    ...
    {
        f.send_pid1 = 0;
		ANO_DT_Send_PID(1,	ANO_data.pid1.kp,ANO_data.pid1.ki,ANO_data.pid1.kd,	\
			ANO_data.pid2.kp,ANO_data.pid2.ki,ANO_data.pid2.kd, \
...
void ANO_DT_Data_Receive_Anl(u8 *data_buf, u8 num)
{
    ...
    {
		ANO_data.pid1.kp = 1*( (vs16)(*(data_buf+4)<<8)|*(data_buf+5) );
